package com.example.xiyouquery.base.net

import com.example.xiyouquery.base.common.Constant.SERVER_ADDRESS
 ...
 */
class ZFRetrofitFactory private constructor() {
    companion object {
        val INSTANCE: ZFRetrofitFactory by lazy { ZFRetrofitFactory() }
    }
